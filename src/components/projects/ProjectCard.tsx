...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Link
      href={project.details ? project.projectDetailsPageSlug : '#'}
      className="group block h-full w-full"
    >
      <Card className="h-full w-full overflow-hidden border-gray-100 p-0 shadow-none transition-all hover:border-gray-300 dark:border-gray-800 dark:hover:border-gray-600">
        ...
        {project.details && (
          <CardFooter className="flex flex-wrap items-center justify-between gap-4 p-6 pt-0">
            <div
              className={`flex w-fit items-center gap-1 rounded-md px-2 py-1 text-xs ${
                project.isWorking
